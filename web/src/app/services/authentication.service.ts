  ...
  return {
    ...
    metadata: {
      ...
      authorization_endpoint:
        "https://prepiam.ice.ibmcloud.com/oidc/endpoint/default/authorize",
    },
    signingKeys: [
      {
        kty: "RSA",
